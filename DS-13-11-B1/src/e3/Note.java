...
public class Note
{
    ...
    public boolean equals(Object o)
    {
        ...
        if (Float.compare(this.getTime(),note.getTime())==0)
        {
            ...
            else
            {
                ...
                else return(NoteEquivalente.sonEquivalentes(this.getNote(), this.getAccidentals(),note.getNote(),note.getAccidentals()));
            }
        }
        else return (false);
    }
    ...
    public int hashCode()
    {
        Note nota=this.notaEquivalente();
        return Objects.hash(nota.getNote(), nota.getAccidentals(), time);
    }

    private Note notaEquivalente()
    {
        ...
        Note notaBuscada=new Note(this.getNote(), this.getAccidentals(), 1.f);
    ...
    {
        return(NoteEquivalente.sonEquivalentes(this.getNote(), this.getAccidentals(),nota.getNote(),nota.getAccidentals()));
